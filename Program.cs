    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            //Punto 18
            //Escriba un programa que traduzca una palabra en español en su código morse equivalente. Los caracteres deben ser validados contra la representación en el alfabeto morse. Se debe controlar si la palabra que ingresa el usuario, tiene algún carácter que no esté en el alfabeto morse.

            //Punto 19
            //Hay un sistema de iluminación en una habitación, que se mantiene encendido solamente cuando hay alguien en moviéndose en la habitación(imagine un sensor de movimiento). Diseñe un programa que calcule cuánto tiempo ha estado encendida la iluminación. Como entrada se le dará un conjunto de intervalos que representa como enteros los tiempos de entrada y salida de alguien a la habitación Cuando los tiempos se solapan, se necesita encontrar el tiempo entre el número más pequeño y el más grande en ese intervalo.
